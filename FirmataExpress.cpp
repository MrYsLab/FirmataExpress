/*
  FirmataExpress.cpp - Firmata library v2.5.8 - 2018-04-15
...
/**
 * Initialize the default Serial transport at the default baud of 115200.
 */
 ...
 * @param speed The baud to use. 115200 baud is the default value.
 */
